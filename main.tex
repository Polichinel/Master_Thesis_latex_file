...
\end{displayquote}
https://www.overleaf.com/project/5bffcaeb9f0680655d7d2a05
...
% \begin{figure}[!htb]
%  	\centering
%	\includegraphics[scale=0.47]{feature_imp.pdf}
%   \caption{\footnotesize{stuff..}}\label{feature_imp}
% \end{figure}
...
The goal of this thesis was to present a novel approach to using past temporal and spatial conflict patterns to predict patterns of future conflicts. I critiqued past efforts -- esitmations and predictions alike -- for not creating features which effectivly captures the nature of conflict patterns in a theoretically and methodological coherent manner.\par

%I argued that past efforts have failed to create features which effectivly captures the nature of conflict patterns in a theoretically and methodological coherent manner. I then theory can be combined with modern machine learning techniques to turn  

% How did you do that?
To ammend this problem I introduced and applied the machine learning technique of Gaussian processes to capture the patterns of past conflicts. I choose Gaussian processes since they properties and following assumptions align remarkable well with the theory on conflict diffusion through both time and space. Using Gaussian processes I created eight features pertaining the the spatial and temporal patterns of conflicts. These patterns were extrapolated into future years and the extrapolations used to predict the probability of conflict in the geographical grid cells, which I used as unit of analysis.\par

% Important and nice things about the shit you did:
Importantly ... 
...
% but what about pattern recognition with ANN?
