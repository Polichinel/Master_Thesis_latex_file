...
% compared
While direct comparison with previous efforts is difficult, the framework presented here does at least as well, if not better, than the state of the art. Notably this is done using only past patterns, and in a setting which emulates a real world scenario. 
